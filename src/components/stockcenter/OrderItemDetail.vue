      ...
      <div class="card card-body">
        <div class="form-row task-item-container ">
          ...
          <div class="form-group-sm col-md-3">
            ...
            <div id="expectedTime">
              <date-picker v-model="expectedTime" value-type="format" format="YYYY-MM-DD"
                           :disabled-date="disabledDate(row.stock.usagetype)"></date-picker>
            </div>
          </div>
          <!--  物种  -->
          <div class="form-group-sm col-md-3">
          ...
          <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" id="strain" :value="row.animal.stockId" disabled
                   placeholder="例：w1118">
          </div>
          <!--  处女蝇  -->
          <div class="form-group col-md-3">
          ...
          <div class="form-group-sm col-md-3" :class=" isHybridizationNecessary == 'Y' ? 'was-validated':''">
            ...
            <multiselect id="hybridStrain"
                         ...
                         :show-labels="false"
                         track-by="selfindex"
                         :custom-label="selfindexWithGene"
            >
          ...
          <div class="form-group-sm col-md-12">
            ...
            <textarea class="form-control" id="operationProcess" v-model="operationProcess"
                      placeholder="例：转管，喂食：先CO2麻醉，转移到新的管子，喂食含有染料的蔗糖水" rows="2"></textarea>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    moment,
    selfindexWithGene :function ({selfindex,genotype}){
      return `${selfindex} -【${genotype}】`;
    },
    range(start, end) {
      const result = [];
