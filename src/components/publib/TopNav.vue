            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="task" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            {{$t("nav_task")}}
                        </a>
...
<!--                            <a class="dropdown-item">{{$t("useTask")}}</a>-->
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="personal" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            {{$t("nav_stock")}}
                        </a>
                        <div class="dropdown-menu" aria-labelledby="personal">
                            <router-link to="/stock/currentStrain"><a class="dropdown-item">{{$t("current_strain")}}</a></router-link>
